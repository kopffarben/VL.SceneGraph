...
| **[10-INPUT-SYSTEM.md](architecture/10-INPUT-SYSTEM.md)** | Input-Provider als Clips, Channels als Input-Bus, Hit-Testing, Focus, MIDI/OSC/Pen, InputMapping, Device-Config |
